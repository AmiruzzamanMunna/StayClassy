...
@section('container')
	<div class="container c1">
		<div class="row">
			...
			<div class="col-md-2">
				<img src="images/bag-2.jpg" class="rounded-circle crc" alt="logo">
				<button type="button" class="btn btn-danger"><a href="http://localhost:8000/details4">Buy Now</a></button>
				<p><b id="b">Name b</b></p>
