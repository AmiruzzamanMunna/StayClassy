...
@section('container')
	<div class="col-md-8"><br><br><br>
		<form action="" method="post">
			<div class="card">
				<div class="card-header"><h2>Quality Policy</h2></div>
				<div class="card-body">
					{{csrf_field()}}
					...
					<div class="row">
						<div class="col-md-3">
							<button type="submit" class="btn btn-primary" name="" value="Save"><a style="color: white" href="{{route('footer.qualityedit',[$qualitys->id])}}">Edit</a></button>
						</div>
